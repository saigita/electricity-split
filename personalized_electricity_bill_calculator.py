...
def main():
    ...
    total_units = float(input("Enter total units consumed: "))
    total_bill = float(input("Enter total bill amount (Rs): "))
    print("\nEnter individual unit consumption:")
    person1_units = float(input("Saigita's units: "))
    person2_units = float(input("Kaushiki's units: "))
    person3_units = float(input("Rucheta's units: "))
